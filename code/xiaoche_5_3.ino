...
// ===== 固件 5.3：前进后退按键修正 + 编码器航向保持 + 网页左转/右转角 =====
static const char FIRMWARE_VERSION[] = "5.3";
...
<body>
  <div class="card">
    ...
    <div class="hint">PWM -3600~3600，速度 -1000~1000。固件 5.3：前进/后退预设已纠正；航向由编码器差速估计；左转/右转角 0~180（数字即可）。</div>
  </div>
